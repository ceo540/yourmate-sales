        ...
        return (
          ...
          {orgView && (
            <OrgTreeView
              ...
              deptEditForm={deptEditForm}
              setDeptEditForm={setDeptEditForm}
              showDeptAddForm={showDeptAddForm}
              setShowDeptAddForm={setShowDeptAddForm}
              deptAddForm={deptAddForm}
              setDeptAddForm={setDeptAddForm}
            />
          )}
            ...
            {selectedUser && (
              <div className="flex-1 bg-white border border-gray-200 rounded-2xl overflow-hidden min-w-0">
                ...
                <div className="p-5">
                  ...
                  {/* 원온원 */}
                  {hrDetailTab === 'oo' && (
                    <OneOnOneSection userId={selectedUser.id} records={oneOnOnes} setRecords={setOneOnOnes} />
                  )}
