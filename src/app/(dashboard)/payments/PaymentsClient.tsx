        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-100 bg-gray-50">
              ...
              <th className="text-right text-xs font-semibold text-gray-500 px-4 py-3.5">금액</th>
                ...
                <td className="px-5 py-3.5">
                  {c.vendor ? (
                    <div>
                      ...
                      <p className="text-xs text-gray-400">{c.vendor.type} {c.vendor.phone ? `· ${c.vendor.phone}` : ''}</p>
                    </div>
                  ) : (
