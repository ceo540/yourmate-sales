    ...
    <>
      ...
      <div className="fixed right-0 top-0 bottom-0 z-50 w-[480px] max-w-[95vw] bg-white shadow-2xl flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-4">
          ...
          {/* 계약단계 */}
          <div>
            <label className="block text-xs font-semibold text-gray-400 uppercase tracking-wide mb-1.5">계약 단계</label>
        ...
        <div className="px-6 py-4 border-t border-gray-100 flex items-center gap-2 flex-shrink-0">
          ...
          <button
            onClick={() => router.push(sale.project_id ? `/projects/${sale.project_id}` : `/sales/${sale.id}?from=/sales/report`)}
