...
export const SERVICE_TASK_TEMPLATES: Record<string, TaskTemplate[]> = {
  'SOS': [
    ...
    { title: '계약 확정 및 요청사항 송부', priority: '높음', description:'공연장 사진·프로젝터 사용 확인, 사전 사연 작성 폼 전달' },
    ...
    { title: '공연 진행', priority: '높음', description:'본 공연 4시간 전 입장, 장비 세팅, 테크·아티스트 리허설' },
    { title: '공연 후 감사 메시지 발송', priority: '낮음', description:'사후 설문지 취합, 홍보용 자료 회수' },
    { title: '콘텐츠 제작 및 업로드', priority: '낮음', description:'스케치 영상(1주일 후), 인터뷰, 스페셜클립 순 업로드' },
  ...
  '교육프로그램': [
    { title: 'CS 응대 및 CRM 작성', priority: '높음' },
    { title: '견적서 발송', priority: '높음' },
    { title: '계약 확정 및 강사·기관 일정 조율', priority: '높음', description:'노션·드롭박스 프로젝트 폴더 생성, 운영계획안 확보' },
    { title: '사전 안내 및 사전답사', priority: '보통', description:'학급 교사에게 협조사항 안내문·동의서 전달, 수업 환경 파악' },
    { title: '강사 교육 및 수업자료 전달', priority: '보통', description:'강사 메뉴얼, PPT(구글슬라이드), 녹음수업 가이드, 사진 요청 사전 안내' },
  ...
  '납품설치': [
    ...
    { title: '마케팅 콘텐츠 발행', priority: '낮음', description:'블로그, 인스타그램, 유튜브' },
  ],
  ...
  '콘텐츠제작': [
    ...
    { title: '계약 체결', priority: '높음', description:'공공기관은 나라장터 진행' },
  ...
  '002ENT': [
    ...
    { title: '고객 정보 및 음원 정보 파악', priority: '높음', description:'드롭박스·노션 유통DB 업데이트' },
