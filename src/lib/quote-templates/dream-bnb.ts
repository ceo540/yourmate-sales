// 드림비앤비 견적서 템플릿
//
// 사업자 정보는 {{entity_*}} 치환으로 들어옴 (business_entities.short_name = '드림비앤비').
// 공공이코 기준 포맷에서 헤더 색상 등 시각적 차이만 분리.

export const DREAM_BNB_TEMPLATE = `<!DOCTYPE html>
<html lang="ko">
<head>
<meta charset="utf-8">
...
.bg-accent { background-color: #e6f0fa; }
.no-border { border: none !important; }
@media print { body { -webkit-print-color-adjust: exact; print-color-adjust: exact; } }

.doc-title { font-size: 18pt; font-weight: bold; letter-spacing: 0.5em; text-align: center; padding: 10px 0; border-top: 2pt solid #2a6cc9; border-bottom: 2pt solid #2a6cc9; color: #2a6cc9; margin-bottom: 5mm; }
.doc-meta { font-size: 8.5pt; margin-bottom: 4mm; }
.doc-meta td { border: none; padding: 2px 4px; }
.intro { font-size: 9pt; text-align: center; border-top: 0.5pt solid #2a6cc9; border-bottom: 0.5pt solid #2a6cc9; padding: 4px; margin: 3mm 0; font-weight: bold; color: #2a6cc9; }
.items th { background-color: #c8dcef; text-align: center; font-weight: bold; font-size: 8.5pt; }
