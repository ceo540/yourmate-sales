...
|---|---|---|---|
| **Sound of School** | 학교 방문공연 (핵심) + 음향 운영 | **발표회·축제 겸업 多** — 공연 외 형태도 다른 사업과 같이 진행 | — |
| **Artkiwoom** | 교육 프로그램 기획·운영. 발주사·강사·일정 | **교육 기반 발표회·영상 제작 등 다른 사업과 겸업 多** — 운영 중심 + 콘텐츠 결과물 | — |
...
**사업부 겸업 = 한 프로젝트에 여러 사업부 참여의 자연스러운 결과** (예: Artkiwoom 교육 프로그램 + SOS 발표회 + 002C 영상 = 1 프로젝트). §3.2 N:M 데이터 모델이 이걸 표현.
